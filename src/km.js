...
$.extend(CM.commands,{
  ...
  DO:function(cm){ //delete comment
    ...
    var a=cm.listSelections(),u=cm.getSelections();cm.replaceSelections(u.map(function(s){return s.replace(/^⍝/gm,'')}))
...
var informal=[
  ...
  '⊆ leftshoeunderbar encloseifsimple conditionalenclose partition',
  '@ at amend merge'
]
