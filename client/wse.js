...
this.WSE=function($e,ide){
  ...
  this.$e=$e
    .jstree({plugins:[],core:{animation:0,check_callback:true,data:function(x,f){
      var i=x.id==='#'?0:+x.id.replace(/\D+/g,'');pending[i]=f.bind(this);ide.emit('TreeList',{nodeId:i})
    }}})
    .on('click','.jstree-anchor',function(){ide.emit('Edit',{win:0,pos:0,text:$e.jstree('get_path',this,'.')})})
}
this.WSE.prototype={
