...
```json
["Subscribe", { // Interpreter -> RIDE
  "status": "statusfields" | "stack" | "threads",
  "heartbeat": 123 // interval not currently used
}]
```
...
To pause all threads, pass a 1. To unpause / resume all threads, pass a 0.
```json
["PauseAllThreads", { "pause": 1 | 0}] // check with Morten
```
